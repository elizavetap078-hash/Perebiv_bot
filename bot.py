...
async def main():
    print("Perebiv_bot starting...", flush=True)

    # Long polling is used on Render. Remove any old webhook first.
    ...
    try:
        ...
        print("Perebiv_bot stopped.", flush=True)
...
if __name__ == "__main__":
    try:
        ...
        print("Perebiv_bot stopped by keyboard.", flush=True)
